...
# The gcc-c-api objects are compiled with ../autogenerated-EXTRA_CFLAGS.txt
$(LIBGCC_C_API_SO): $(pwd)/gcc-c-api autogenerated-EXTRA_CFLAGS.txt
...
# autogenerated-tree.c includes autogenerated-casts.h
autogenerated-tree.o: autogenerated-casts.h
